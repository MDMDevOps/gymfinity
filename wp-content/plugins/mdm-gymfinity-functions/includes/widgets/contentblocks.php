...
namespace Mdm\Gymfinity\Widgets;

use \Mdm\Gymfinity\Utilities as Utilities;

class ContentBlocks extends \WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_id_base = 'mdm_ads_manager_adgroup';
		$this->widget_name    = 'Ad Group';
		$this->widget_options = array( 'classname' => 'mdm_ads_manager_adgroup', 'description' => 'Display Ad Groups' );
		// Construct parent
	...
	public function form( $instance ) {
		...
		include Utilities::path( 'partials/forms/adgroup_widget.php' );
	} // end form()
